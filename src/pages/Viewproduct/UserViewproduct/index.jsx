...
import { Box, Button, Group, Image, Modal, Text, TextInput, Textarea, Title, rem, } from "@mantine/core";
...
function UserViewProduct() {
    ...
    const { addUserReviewProduct } = authApi()
    ...
    const handleSubmitforReview = async () => {
        ...
        try {
            const response = await addUserReviewProduct(reviewValues)
            open()
        ...
        <>
            ...
            <Box>
                ...
                >
                    ...
                    >
                        <Title size={20}>Your request is under verification </Title>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >Submit changes for approval</Button>
                                    </Box>
